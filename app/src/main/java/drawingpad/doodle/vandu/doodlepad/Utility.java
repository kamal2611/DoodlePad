...
{
    static final String dirName = "doodle.vandu.drawingpad";
    ...
    static final String packageName = "drawingpad.doodle.vandu.doodlepad";
    static final String classGalleryName = "drawingpad.doodle.vandu.doodlepad.DoodleGalleryActivity";
